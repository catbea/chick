 ...
 * 显示loding动画
 */
Wu.prototype.showChickLoding = function(){
	var el = document.createElement("div");
	el.className = "chickLodingMain";
 ...
 * 隐藏loding动画
 */
Wu.prototype.hideChickLoding =  function(){
	var load =document.querySelector(".chickLodingMain");
	if(load) {
...
// 隐藏loading
Wu.prototype.hideLoading =function(){
	var load = document.querySelector(".wu-toast");
	if(load) {
		load.parentNode.removeChild(load);
	};	
...
Wu.prototype.showDialog = function(ops) {
	...
	function removeDialog() {
		...
		document.body.removeEventListener('click', dialogHandlerr, false)
	}
